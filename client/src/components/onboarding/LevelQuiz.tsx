...
const QUIZ_QUESTIONS = [
  ...
  },
  {
    ...
    options: ['Выводит текст на экран', 'Запрашивает ввод от пользователя', 'Создаёт список', 'Это ошибка'],
    correct: 1,
  ...
  },
  {
    ...
    options: ['Специальное слово языка', 'Блок кода, который можно вызывать по имени', 'Тип данных', 'Способ вывести текст'],
    correct: 1,
